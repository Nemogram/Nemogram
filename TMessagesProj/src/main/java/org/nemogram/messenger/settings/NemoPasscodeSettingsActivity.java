...
import org.nemogram.messenger.settings.cells.AccountCell;
...
public class NemoPasscodeSettingsActivity extends BaseNemoSettingsActivity {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        var link = String.format(Locale.ENGLISH, "https://t.me/nemosettings/%s", PasscodeHelper.getSettingsKey());
    ...
    protected String getActionBarTitle() {
        return LocaleController.getString(R.string.PasscodeNemo);
    }
