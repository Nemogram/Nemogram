...
package org.nemogram.messenger.appcompat;

import static org.nemogram.messenger.appcompat.AppCompatReceiveContentHelper.maybeHandleDragEventViaPerformReceiveContent;
import static org.nemogram.messenger.appcompat.AppCompatReceiveContentHelper.maybeHandleMenuActionViaPerformReceiveContent;
...
public class AppCompatEditText extends EditText implements OnReceiveContentViewBehavior {
    ...
    public AppCompatEditText(@NonNull Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
