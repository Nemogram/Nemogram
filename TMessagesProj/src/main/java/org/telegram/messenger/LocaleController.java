...
public class LocaleController {
    ...
    private String getStringInternal(String key, String fallback, int res) {
        return getStringInternal(key, fallback, 0, res);
    }
    ...
    private String getStringInternal(String key, String fallback, int fallbackRes, int res) {
        if ("AppName".equals(key) || res == R.string.AppName) {
            try {
                return getLocalizedString(R.string.Nemogram);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
        if ("AppNameBeta".equals(key) || res == R.string.AppNameBeta) {
            try {
                return getLocalizedString(R.string.NemogramBeta);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    private String getLocalizedString(@StringRes int res) {
        checkLocalizationInternal();
        return localizationInternal.getByResId(ApplicationLoader.applicationContext, res);
    }
